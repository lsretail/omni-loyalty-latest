...
namespace Presentation.Screens
{
	public partial class MapController : UIViewController
	{
		...
		public MapController (Store currentLocation, List<Store> allLocations)
		{
		...
		public MapController (List<Store> allLocations) : base ("MapViewScreen", null)
		{
			this.locationManager = new CLLocationManager ();
			this.allLocations = allLocations;
		...
		public override void LoadView ()
		{
			...
			mapDelegate = new MapDelegate (this);
			...
			locationManager.Failed += async (sender, e) => 
			{
				...
				else
				{
					...
					if (this.allLocations.Count > 0)
					{
						...
						currentLocationCoord = new CLLocationCoordinate2D (allLatitudes.Average(), allLongitudes.Average());
					}
