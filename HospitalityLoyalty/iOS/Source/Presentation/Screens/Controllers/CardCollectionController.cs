...
{
	public abstract class CardCollectionController : UICollectionViewController
	{
		...
		public CardCollectionController (UICollectionViewFlowLayout layout) : base (layout)
		{}
