...
namespace Presentation.Utils
{
    ...
    {
        protected static String PREFS_FILE = "device_id.xml";
        protected static String PREFS_DEVICE_ID = "device_id";
        ...
        public DeviceUuidFactory(Context context)
        {
            if (uuid == null)
            {
                ISharedPreferences prefs = context.GetSharedPreferences(PREFS_FILE, 0);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        uuid = deviceId ?? UUID.RandomUUID().ToString();
                    }
