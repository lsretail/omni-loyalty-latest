...
{
    public class OfferAndCouponFragment : BaseFragment, ViewTreeObserver.IOnGlobalLayoutListener
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            pager.Adapter = new OfferAndCouponPagerAdapter(ChildFragmentManager, Activity);
