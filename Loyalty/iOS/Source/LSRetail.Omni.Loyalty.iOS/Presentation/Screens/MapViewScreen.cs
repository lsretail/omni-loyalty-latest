...
{
	/*
	public partial class MapViewScreen : UIViewController
	{
		...
		public MapViewScreen (Store currentLocation, List<Store> allLocations, bool clickCollect) : base ("MapViewScreen", null)
		{
		...
		public MapViewScreen (List<Store> allLocations, bool clickCollect) : base ("MapViewScreen", null)
		{
			this.locationManager = new CLLocationManager ();
			this.allLocations = allLocations;
			this.Title = NSBundle.MainBundle.LocalizedString("MapView_AllLocations", "All locations");
			this.clickCollect = clickCollect;
		}
		...
		public override void ViewDidLoad ()
		{
			...
			locationManager.Failed += (sender, e) => 
			{
				...
				var alert = new UIAlertView(
					NSBundle.MainBundle.LocalizedString("Location_CouldNotGetLocation", "Couldn't get current location"),
					NSBundle.MainBundle.LocalizedString("Location_CouldNotGetLocationInstructions", "Make sure Location Services are enabled. To enable, go to privacy settings and turn Location Services on for this app."),
					null,
				...
				else
				{
					...
					List<decimal> allLatitudes = new List<decimal> ();
					List<decimal> allLongitudes = new List<decimal> ();
